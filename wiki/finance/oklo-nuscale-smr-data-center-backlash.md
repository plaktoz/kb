...
- **[[Small Modular Reactor]] (SMR)**: Compact nuclear reactors deployable in ~2 years; key differentiator vs. conventional nuclear for fast-growing AI compute demand.
- **[[Oklo]]**: SMR startup still awaiting U.S. regulatory construction approval.
...
- **Public Opposition**: ~70% of Americans oppose local data center construction (Gallup).
- **Market Size**: McKinsey projects $7 trillion in global data center spending by 2030.
- **SMR Speed Advantage**: SMRs can potentially deploy in ~2 years — key differentiator.
- **Weakened Urgency**: Slower data center growth reduces SMR's fast-deploy premium.
- **Natural Gas Headwind**: SpaceX natural gas investment may bridge demand before SMRs commercialize.
...
- **[[Catalyst Risk]]**: The SMR bull case depends on a specific sequence of catalysts (regulatory approval → construction → data center demand) all materializing on schedule; backlash introduces a critical dependency that could stall the entire chain before revenue begins.
- **[[Competitive Moat Erosion]]**: SMRs' main moat is deployment speed, but if AI companies face reduced urgency to scale quickly due to backlash, that moat narrows and alternatives (natural gas, conventional nuclear) become viable substitutes.

## 🃏 Review Questions

**Q1**: What is the core thesis concern raised about SMR stocks like Oklo and NuScale?
**A**: Growing public opposition to data centers (~70% of Americans against local construction) may slow AI infrastructure expansion, reducing the urgent demand that makes SMRs' fast-deploy advantage valuable.

**Q2**: What specific regulatory and commercialization gaps exist for Oklo and NuScale?
**A**: Oklo still lacks U.S. regulatory construction approval, and NuScale has not yet commercialized its design — with only two SMR systems built globally as of 2026.

**Q3**: How should an investor weigh SMR stocks given these headwinds?
**A**: The article implies caution: the fast-deploy premium weakens if data center timelines slip, natural gas may bridge near-term demand, and large-scale nuclear from companies like Alphabet competes on longer horizons without the commercialization risk.
