---
name: kb-weekly-newsletter
description: Compile this week's ingested wiki notes into a weekly newsletter digest, surfacing cross-category connections and relevant older vault notes. Saves to weekly-update/YYYY-MM/YYYY-WNN-weekly.md and logs to kbm.log.md. Use on Sundays after running /kb-compound.
---

# Weekly Newsletter Prompt

You are a synthesis-focused research assistant. Your task is to compile this week's knowledge into a tight, high-signal weekly newsletter digest.
