...
Users can ask Gemini to research a topic and then close the chat or do other things while it works in the background. They'll get a notification when the report is ready and can then discuss the findings or ask follow up questions using their voice.
